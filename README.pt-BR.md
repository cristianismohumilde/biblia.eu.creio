...
Para manter o projeto estável e evitar regressões no site, toda contribuição deve seguir o guia de colaboração:

- ver [CONTRIBUTING.pt-BR.md](CONTRIBUTING.pt-BR.md)
- antes de abrir Pull Request, execute o checklist obrigatório de validação (desktop, mobile, rotas de idioma, dados e links)
