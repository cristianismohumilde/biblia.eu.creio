  ...
  const content = {
      ...
      articles: [
        {
          ...
          headline: "Estamos de Casa Nova: Conheça o AI-BIBLE",
          paragraphs: [
            "Temos uma grande novidade! O nosso projeto evoluiu e agora está hospedado em um novo endereço: <a href='https://cristianismohumilde.github.io/AI-BIBLE/' target='_blank' rel='noopener noreferrer' style='color: #00ebff; text-decoration: underline;'>https://cristianismohumilde.github.io/AI-BIBLE/</a>.",
            "Esta mudança marca uma nova fase para nós. No novo site, você encontrará um leitor muito mais otimizado, veloz e o mais importante: com uma tradução interlinear muito mais completa e precisa gerada por Inteligência Artificial.",
            "Todas as funcionalidades que você já conhece (como o áudio dos originais e a análise morfológica) também estão disponíveis lá, mas com um banco de dados expandido que cobre ainda mais passagens da Bíblia.",
            "Recomendamos que você atualize seus favoritos e passe a utilizar o novo portal para seus estudos bíblicos. Acesse agora mesmo clicando no link acima e experimente a nova plataforma!"
          ]
        },
        {
    ...
    en: {
      ...
      articles: [
        {
          date: "May 23, 2026",
          headline: "We Have Moved: Welcome to AI-BIBLE",
          paragraphs: [
            "We have great news! Our project has evolved and is now hosted at a new address: <a href='https://cristianismohumilde.github.io/AI-BIBLE/' target='_blank' rel='noopener noreferrer' style='color: #00ebff; text-decoration: underline;'>https://cristianismohumilde.github.io/AI-BIBLE/</a>.",
            "This change marks a new phase for us. On the new site, you will find a much more optimized and faster reader, and most importantly: a much more complete and accurate interlinear translation generated by Artificial Intelligence.",
            "All the features you already know (like original audio and morphological analysis) are also available there, but with an expanded database that covers even more Bible passages.",
            "We recommend that you update your bookmarks and start using the new portal for your biblical studies. Access it right now by clicking the link above and experience the new platform!"
          ]
        },
        {
          date: "May 06, 2026",
