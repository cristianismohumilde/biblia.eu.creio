  ...
  const content = {
    pt: {
      manuscripts: {
        ...
        items: [
          { title: "📜 Tradição Hebraica (Texto Massorético)", text: "O Codex Leningradensis (B19A) é o manuscrito completo mais antigo da Bíblia Hebraica (1008 d.C.), servindo como base para as principais edições acadêmicas modernas (BHS). O Codex de Aleppo, embora incompleto, é considerado a testemunha mais autoritativa da pontuação e acentuação massorética. Ambos garantem a preservação técnica do texto do Antigo Testamento." },
          { title: "🏺 Manuscritos do Mar Morto (DSS)", text: "Descobertos nas cavernas de Qumran, os Manuscritos do Mar Morto representam os textos bíblicos mais antigos já encontrados (séc. III a.C. a séc. I d.C.). Eles são fundamentais para atestar a impressionante estabilidade e fidelidade da transmissão do Texto Massorético ao longo dos milênios, além de documentarem variantes textuais valiosas que frequentemente se alinham com a Septuaginta (LXX)." },
      ...
      lexicons: {
        ...
        items: [
          ...
          { title: "📜 Léxico Peshitta Siríaco", text: "A Peshitta, versão 'simples' do Antigo e Novo Testamento em siríaco, carrega um léxico profundamente ligado às raízes semíticas da língua hebraica e aramaica. Os léxicos da Peshitta siríaca, baseados em tradições textualmente antigas, permitem rastrear como termos bíblicos foram interpretados e traduzidos por comunidades cristãs semíticas muito próximas do período e contexto do texto original. O siríaco preserva nuances linguísticas perdidas em tradições posteriores." },
    ...
    en: {
      manuscripts: {
        ...
        items: [
          { title: "📜 Hebrew Tradition (Masoretic Text)", text: "The Codex Leningradensis (B19A) is the oldest complete manuscript of the Hebrew Bible (1008 AD), serving as the basis for major modern academic editions (BHS). The Aleppo Codex, although incomplete, is considered the most authoritative witness to Masoretic pointing and accentuation. Both ensure the technical preservation of the Old Testament text." },
          { title: "🏺 Dead Sea Scrolls (DSS)", text: "Discovered in the caves of Qumran, the Dead Sea Scrolls represent the oldest biblical texts ever found (3rd century BC to 1st century AD). They are fundamental to attesting the impressive stability and fidelity of the transmission of the Masoretic Text over the millennia, as well as documenting valuable textual variants that frequently align with the Septuagint (LXX)." },
      ...
      lexicons: {
        ...
        items: [
          ...
          { title: "📜 Syriac Peshitta Lexicon", text: "The Peshitta, the 'simple' version of the Old and New Testament in Syriac, carries a lexicon deeply connected to the Semitic roots of Hebrew and Aramaic. The lexicons of the Syriac Peshitta, based on textually ancient traditions, allow us to trace how biblical terms were interpreted and translated by Semitic Christian communities very close to the period and context of the original text. Syriac preserves linguistic nuances lost in later traditions." },
