    ...
    pt: {
      ...
      lexicons: {
        ...
        items: [
          ...
          { title: "🏺 W.E. Crum (Copta) e Matthias Bedrossian (Armênio)", text: "Crum é a autoridade absoluta para o Copta, essencial para entender a Bíblia no Egito cristão. Bedrossian fornece o dicionário mais detalhado para o Armênio clássico (a 'Rainha das Versões'), permitindo captar a precisão e a beleza desta tradição textual tão importante para a crítica textual." }
        ]
      },
      about: {
